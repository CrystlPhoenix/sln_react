...
const PartnersNCustomers = () => {
  const customers = [
    ...
    {
      name: "Ariel",
      src: "new_section_images/customers/ariel.jpeg",
    },
    {
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-sm md:text-base text-gray-600 mt-3 max-w-2xl mx-auto">
              Trusted by leading organizations and supported by globally
              recognized electrical and power technology partners.
            </p>
          </div>
      ...
      object-contain"
            ...
            <p className="text-xs text-gray-500 mt-4">
              Selected organizations we have delivered engineering solutions to
    ...
    hover:shadow-md transition"
      ...
      object-contain"
            ...
            <p className="text-xs text-gray-500 mt-4">
              We are certified partners of leading global electrical and
              automation brands.
            </p>
          </div>
        </div>
